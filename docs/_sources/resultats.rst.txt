...
Comme mentionné précédemment, la base de données de départ de SimGen correspond à la `Base de données de simulation de politiques sociales (BDSPS) <https://www.statcan.gc.ca/fra/microsimulation/bdmsps/bdmsps>`_.
