...
Dans tous les cas, veillez lire les `condition d'utilisation <https://pypi.org/policy/terms-of-use/>`_ du site internet *pypi* qui héberge le package.
...
#. Une fois le fichier décompressé, transférez le dossier "simgen-x.x.x" qui en résulte dans le dossier où vous entreposez vos packages (si vous n'en avez pas, créez-en un à l'endroit qui vous convient le mieux).
